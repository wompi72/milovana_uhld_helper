// ==UserScript==
// @name        Milovana: Ultimate Hentai Lottery of Denial
// @namespace   Violentmonkey Scripts
// @match       https://milovana.com/webteases/showtease.php?id=37913*
// @grant       none
// @version     1.1
// @author      wompi72
// @updateURL    https://raw.githubusercontent.com/wompi72/milovana_uhld_helper/master/version1.user.js
// @downloadURL  https://raw.githubusercontent.com/wompi72/milovana_uhld_helper/master/version1.user.js
// @description All help utilities and stat tracking for Ultimate Hentai Lottery of Denial on Milovana.com
// ==/UserScript==


(function () {
    // START SCRIPT DIFFERENCE BETWEEN 1 and 2: 11111111111111111111111111111111111111111111111111
    const STORAGE_PREFIX = 'hentai_denial_';
    const PANEL_TITLE = "Hentai Denial Helper ";
    const BASE_URL = "https://milovana.com/webteases/showtease.php?id=37913";
    const PAGES_START = 3;
    const PAGES_END = 113;
    const DEFAULT_DIFFICULTY = 'Chastity';

    const DIFFICULTY_CONSTS = {
        Weak: {
            CHASTITY_MAX_DEFAULT: 14,
            PAUSE_AFTER_EDGE: 60,
            PAUSE_AFTER_UNAUTHORIZED_EDGE: 120,
            PAGES_UNTIL_PAUSE: 6,
            PAUSE_DURATION_HOURS: 12,
            PENALTY_FOR_RO: 1,
            POINTS_PENALTY_FOR_RO: 500,
            POINTS_PENALTY_FOR_LEAVING: 150,
            CHASTITY_PENALTY_FOR_LEAVING: 3,
            ALT_LABELS: []
        },
        Chastity: {
            CHASTITY_MAX_DEFAULT: 14,
            PAUSE_AFTER_EDGE: 40,
            PAUSE_AFTER_UNAUTHORIZED_EDGE: 90,
            PAGES_UNTIL_PAUSE: 6,
            PAUSE_DURATION_HOURS: 12,
            PENALTY_FOR_RO: 3,
            POINTS_PENALTY_FOR_RO: 500,
            POINTS_PENALTY_FOR_LEAVING: 150,
            CHASTITY_PENALTY_FOR_LEAVING: "AT_LEAST_HALF",
            ALT_LABELS: []
        },
        Hardcore: {
            CHASTITY_MAX_DEFAULT: 30,
            PAUSE_AFTER_EDGE: 30,
    ...
    // END SCRIPT DIFFERENCE BETWEEN 1 and 2: 11111111111111111111111111111111111111111111111111
    ...
    // START SCRIPT DIFFERENCE BETWEEN NORMAL AND COMBI: 11111111111111111111111111111111111111111111111111
    ...
    // END SCRIPT DIFFERENCE BETWEEN NORMAL AND COMBI: 11111111111111111111111111111111111111111111111111
